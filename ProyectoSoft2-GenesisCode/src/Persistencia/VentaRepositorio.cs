...
namespace Persistencia
{
    ...
    public class VentaRepositorio:
		IEntidadRepository<IDocumentCollection<Venta>,IEnumerable<Venta>>
	{
		...
		public IDocumentCollection<Venta> getDataEntidad()
		{
			IDocumentCollection<Venta> collection = store.GetCollection<Venta>();
			return collection;
		}

		// Este esta centrado en el uso de consultas de una entidad
		public IEnumerable<Venta> getQueryEntidad()
		{
			IDocumentCollection<Venta> collection = store.GetCollection<Venta>();
